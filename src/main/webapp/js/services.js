...
yuMailApp.factory('AuthenticationService', ['$http', '$cookieStore', '$rootScope', 'AjaxService', function($http, $cookieStore, $rootScope, AjaxService) {
	'use strict';
...
yuMailApp.factory('AjaxService', [ '$rootScope', '$http', function($rootScope, $http) {
...
yuMailApp.directive('access', ['AuthenticationService', function(AuthenticationService) {
	return {
        restrict: 'A',
